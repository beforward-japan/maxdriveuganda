...
const services = [
  { icon: Search, title: "Vehicle Sourcing", desc: "Professional vehicle selection based on your budget and requirements." },
  { icon: FileText, title: "Transparent Quotation", desc: "Complete cost breakdown with no hidden fees or surprises." },
